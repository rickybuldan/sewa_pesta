                            ...
                            <div class="mb-0 p-0 p-lg-3">
                                <div class="mb-0 border-0 p-md-4 p-lg-0">
                                    ...
                                    <div class="auth-title-section mb-4 text-lg-start text-center">
                                        <h3 class="text-dark fw-semibold mb-3">Welcome back! Please Sign in to continue.
                                        </h3>
                                        <p class="text-muted fs-14 mb-0">Sign up today to unlock exclusive content, enjoy
                                            special offers, and be the first to hear about exciting updates and
                                            announcements.</p>
                                    </div>
