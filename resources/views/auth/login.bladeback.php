...
<body class="vh-100">
	<div class="page-wraper">
		...
		<div class="browse-job login-style3">
			<!-- Coming Soon -->
			<div class="bg-img-fix overflow-hidden" style="background:#fff url({{ asset('template/admin/images/background/bg6.jpg') }}); height: 100vh;">
				<div class="row gx-0">
										...
										<div class="tab-content w-100" id="nav-tabContent">
										  <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
											<form action="{{ route('login') }}" method="POST" class=" dz-form pb-3">
                                                    @csrf
													<h3 class="form-title m-t0">Login MySalon</h3>
												...
												<div class="text-center bottom"> 
													{{-- <button class="btn btn-primary button-md btn-block" id="nav-sign-tab" data-bs-toggle="tab" data-bs-target="#nav-sign" type="button" role="tab" aria-controls="nav-sign" aria-selected="false">Create an account</button> 
													 --}}
													 <a class="btn btn-primary button-md btn-block" href="{{route('sign-up')}}">Create an account</a> 
												</div>
										  </div>
										  ...
										  <div class="tab-pane fade" id="nav-sign" role="tabpanel" aria-labelledby="nav-sign-tab">
											<form class="dz-form py-2">
												...
												<div class="form-group mt-3">
													<input name="dzName" required="" id="form-name" class="form-control" placeholder="Full Name" type="text">
												</div>
												<div class="form-group mt-3">
													<input name="dzName" required=""  id="form-phone" class="form-control" placeholder="Phone" type="number">
												</div>
												<div class="form-group mt-3">
													<input name="dzName" required=""   id="form-email" class="form-control" placeholder="Phone" type="email">
												</div>
												<div class="form-group mt-3">
													<input name="dzName" required=""  id="form-password" class="form-control" placeholder="Password" type="password">
												</div>
												...
												<div class="form-group clearfix text-left">
													...
													<button class="btn btn-primary float-end" id="save-btn">Submit</button>
												</div>
											</form>
