<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html" id="logo-text">
            {{-- <img class="img-fluid"src="{{ asset('template/admin2/assets/images/logo/logo.png') }}" alt=""> --}}
            KIMI SHOP
                        </a></div>
        ...
        {{-- <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100"> <img src="{{ asset('template/admin2/assets/images/giftools.gif') }}"
                        alt="gif">
        ...
        <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
                ...
                <li> <span class="header-search">
                        <svg>
                            <use href="{{asset('template/admin2/assets/svg/icon-sprite.svg#search')}}"></use>
                        </svg></span></li>
                <li class="onhover-dropdown">
                    <svg>
                        <use href="{{asset('template/admin2/assets/svg/icon-sprite.svg#star')}}"></use>
                    </svg>
                ...
                <li>
                    <div class="mode">
                        <svg>
                            <use href="{{asset('template/admin2/assets/svg/icon-sprite.svg#moon')}}"></use>
                        </svg>
                    </div>
                </li>
                <li class="cart-nav onhover-dropdown">
                    <div class="cart-box">
                        <svg>
                            <use href="{{asset('template/admin2/assets/svg/icon-sprite.svg#stroke-ecommerce')}}"></use>
                        ...
                        <ul>
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{asset('template/admin2/assets/images/other-images/cart-img.jpg')}}" alt="">
                ...
                <li class="onhover-dropdown">
                    <div class="notification-box">
                        <svg>
                            <use href="{{asset('template/admin2/assets/svg/icon-sprite.svg#notification')}}"></use>
                    ...
                    <div class="media profile-media"><img class="b-r-10"
                        ...
                        <div class="media-body">
                            @auth
                                ...
                                <p class="mb-0">{{ Auth::user()->roles->first()->role_name }} <i
