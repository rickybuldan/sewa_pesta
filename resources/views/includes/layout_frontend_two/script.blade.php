...
<!-- Template  JS -->
{{-- <script src="{{ asset('template/frontend/js/main.js?v=3.4') }}"></script>
<script src="{{ asset('template/frontend/js/shop.js?v=3.4') }}"></script> --}}

{{-- <script src="{{ asset('template/frontend/js/demo.js') }}"></script> --}}

<!-- All js here -->
<script src="{{ asset('template/frontend2/js/vendor/modernizr-3.5.0.min.js') }}"></script>
{{-- <script src="{{ asset('template/frontend2/js/vendor/jquery-1.12.4.min.js') }}"></script> --}}
<script src="{{ asset('template/frontend2/js/jquery.inputarrow.js') }}"></script>
<script src="{{ asset('template/frontend2/js/popper.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/isotope.pkgd.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/plugins.js') }}"></script>
<script src="{{ asset('template/frontend2/js/wow.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/audioplayer.js') }}"></script>
<script src="{{ asset('template/frontend2/js/slick.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/jquery.meanmenu.min.js') }}"></script>
<script src="{{ asset('template/frontend2/js/main.js') }}"></script>
