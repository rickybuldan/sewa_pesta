        ...
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-top">
                <div class="mobile-header-logo">
                    <a href="index.html"><img src="{{ asset('template/frontend/imgs/theme/logo.svg') }}" alt="logo"></a>
                </div>
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon">
                    ...
                    <a href="#"><img src="{{ asset('template/frontend/imgs/theme/icons/icon-facebook.svg') }}" alt=""></a>
                    <a href="#"><img src="{{ asset('template/frontend/imgs/theme/icons/icon-twitter.svg') }}" alt=""></a>
