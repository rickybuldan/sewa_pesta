                ...
                <li class="dropdown notification-list topbar-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown">
                        ...
                        <div class="dropdown-header noti-title">
                            @auth
                                <h6 class="text-overflow m-0">{{ Auth::user()->roles->first()->role_name }}</h6>
                            @endauth
                        </div>
                        ...
                        <form id="logout" action="{{ route('logout') }}" method="POST">
                            @csrf
                            <a onclick="localStorage.removeItem('savedHTML'); document.getElementById('logout').submit();" class="dropdown-item notify-item">
