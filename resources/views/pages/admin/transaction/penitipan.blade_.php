            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Form Penitipan</h5><span>Pastikan pet house ditiap pet berbeda dan status pet house yang dipilih
                            adalah open.</span>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-lg-4 col-xl-4 mt-3">
                                ...
                                <input class="form-control sisa-bayar" type="number" value=""
