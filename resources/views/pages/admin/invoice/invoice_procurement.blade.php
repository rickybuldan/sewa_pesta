...
<body>
    ...
    <div class="info">
        <div>
            ...
            <strong>No Supplier:</strong><b id="f-phone-customer">-</b><br>
            <strong>Diajukan Oleh:</strong><b id="f-name-customer">-</b><br>
           
        </div>
        <div>
            <strong>Singaparna,<i id="f-rent-date">-</i></strong><br>
            <strong>Disetujui:</strong><b id="f-name-approver">-</b><br>
        </div>
    </div>
