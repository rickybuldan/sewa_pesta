                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('template/frontend/imgs/shop/product-1-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('template/frontend/imgs/shop/product-1-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('template/frontend/imgs/shop/product-2-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('template/frontend/imgs/shop/product-2-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('template/frontend/imgs/shop/product-9-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('template/frontend/imgs/shop/product-9-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('template/frontend/imgs/shop/product-10-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img" src="{{ asset('template/frontend/imgs/shop/product-10-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
    ...
    <section class="banner-2 section-padding pb-0">
        <div class="container">
            <div class="banner-img banner-big wow fadeIn animated f-none">
                <img src="{{ asset('template/frontend/imgs/banner/banner-4.png') }}" alt="">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('template/frontend/imgs/shop/category-thumb-1.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img src="{{ asset('template/frontend/imgs/shop/category-thumb-2.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('template/frontend/imgs/shop/category-thumb-3.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('template/frontend/imgs/shop/category-thumb-4.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('template/frontend/imgs/shop/category-thumb-5.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset('template/frontend/imgs/shop/category-thumb-6.jpg') }}"
                                    alt=""></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow fadeIn animated">
                        <img src="{{ asset('template/frontend/imgs/banner/banner-1.png') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow fadeIn animated">
                        <img src="{{ asset('template/frontend/imgs/banner/banner-2.png') }}" alt="">
                        <div class="banner-text">
                            <span>Sale off</span>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img wow fadeIn animated  mb-sm-0">
                        <img src="{{ asset('template/frontend/imgs/banner/banner-3.png') }}" alt="">
                        <div class="banner-text">
                ...
                <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img" src="{{ asset('template/frontend/imgs/shop/product-4-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('template/frontend/imgs/shop/product-4-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
            ...
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0"
                        style="background-image: url('{{ asset('template/frontend/imgs/banner/menu-banner-7.jpg') }}');">
                        <div class="deal-top">
                            <h2 class="text-brand">Deal of the Day</h2>
                            <h5>Limited quantities.</h5>
                        </div>
                        <div class="deal-content">
                            <h6 class="product-title"><a href="shop-product-right.html">Summer Collection
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated"
                        style="background-image: url('{{ asset('template/frontend/imgs/banner/menu-banner-9.jpg') }}');">
                        <div class="deal-top">
            ...
            <div class="carausel-6-columns-cover position-relative wow fadeIn animated">
                ...
                <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('template/frontend/imgs/banner/brand-1.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover" src="{{ asset('template/frontend/imgs/banner/brand-2.png') }}" alt="">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-flex">
                    <div class="banner-img style-2 wow fadeIn animated">
                        <img src="{{ asset('template/frontend/imgs/banner/banner-9.jpg') }}" alt="">
                        <div class="banner-text">
                    ...
                    <div class="post-list mb-4 mb-lg-0">
                            ...
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('template/frontend/imgs/blog/blog-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                                    <div class="entry-meta mb-10 mt-10">
                                        <a class="entry-meta meta-2"
                                            href="blog-category-fullwidth.html"><span
                        ...
                        <article class="wow fadeIn animated">
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('template/frontend/imgs/blog/blog-1.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                                    <div class="entry-meta mb-10 mt-10">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="banner-img banner-1 wow fadeIn animated">
                                <img src="{{ asset('template/frontend/imgs/banner/banner-5.jpg') }}" alt="">
                                <div class="banner-text">
                        ...
                        <div class="col-md-6">
                            <div class="banner-img mb-15 wow fadeIn animated">
                                <img src="{{ asset('template/frontend/imgs/banner/banner-6.jpg') }}" alt="">
                                <div class="banner-text">
                                    <span>Big Offer</span>
                            ...
                            <div class="banner-img banner-2 wow fadeIn animated">
                                <img src="{{ asset('template/frontend/imgs/banner/banner-7.jpg') }}" alt="">
                                <div class="banner-text">
                                    <span>Smart Offer</span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-bg wow fadeIn animated"
                        style="background-image: url('{{ asset('template/frontend/imgs/banner/banner-8.jpg') }}')">
                        <div class="banner-content">
                            <h5 class="text-grey-4 mb-15">Shop Today’s Deals</h5>
                            <h2 class="fw-600">Happy <span class="text-brand">Mother's Day</span>. Big Sale
                                Up to 40%</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                    <div class="banner-img wow fadeIn animated mb-md-4 mb-lg-0">
                        <img src="{{ asset('template/frontend/imgs/banner/banner-10.jpg') }}" alt="">
                        <div class="banner-text">
                ...
                <div class="col-lg-3 col-md-6 mb-sm-5 mb-md-0">
                    ...
                    <div class="product-list-small wow fadeIn animated">
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('template/frontend/imgs/shop/thumbnail-3.jpg') }}" alt=""></a>
                            </figure>
                        ...
                        <article class="row align-items-center">
                            <figure class="col-md-4 mb-0">
                                <a href="shop-product-right.html"><img
                                        src="{{ asset('template/frontend/imgs/shop/thumbnail-5.jpg') }}" alt=""></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h4 class="title-small">
