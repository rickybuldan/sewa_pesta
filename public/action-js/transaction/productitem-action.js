...
function countSubTotal(prc,  items) {
    return prc *  items;
}
...
function checkValidation() {
    ...
    if (
        validationSwalFailed(
            (isObject["supplier_name"] = $("#supplier-name").val()),
    ...
    if (
        validationSwalFailed(
            (isObject["supplier_phone"] = $("#supplier-phone").val()),
            "Phone Supplier tidak boleh kosong"
        )
    )
        return false;
