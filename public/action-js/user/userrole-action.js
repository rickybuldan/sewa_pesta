...
function getListView() {
    dtview = $("#table-list").DataTable({
        ...
        columnDefs: [
            ...
            {
                mRender: function (data, type, row) {
                    var $rowData = `<button type="button" class="btn btn-sm btn-dark btn-icon-sm permissiondet-btn">Hak Akses</button>`;
                    $rowData += `<button type="button" class="btn btn-sm btn-dark btn-icon-sm edit-btn mx-2">Menu</button>`;
                        ...
                        <div class="course-widget"> 
                          ...
                          <div> 
                            <h6 class="mb-0">${item.role_name
                             ...
                             <button class="btn btn-sm text-bg-light text-center" type="button" onclick='editRole(${item.id
                            },this)'>Edit</button>
                                    <button class="btn  btn-sm text-bg-light text-center" type="button" onclick='deleteRole(${item.id
                            })'>Hapus</button>
                          ...
                          <div> 
                            <div class="d-flex p-2">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button class="btn  btn-sm text-bg-light text-center" type="button" onclick='addRole()'><i class="fa fa-plus"></i>Tambah Role</button>
                                </div>
                            </div>
                          </div>
                        </div>
